...
public class GetUserInfo {
    ...
    public ApiResponse<GetUserInfoResponse> getUserInfo(@RequestParam(value = "user", defaultValue = "") String user) {
        ...
        return ApiUtil.successfulResponse(new GetUserInfoResponse(userEntity.getUsername(), userEntity.getNickname(), userEntity.getDescription(), userEntity.hasAvatar()));
    }
}
